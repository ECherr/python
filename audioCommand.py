...
from speech_demo_json import asr_json
from json_parse import read_result
from play_mp3 import trans_mp3_to_wav
...
def main():
    ...
    asr_json()
    music_mp3 = './audio/' + read_result() + '.mp3'
    music_wav = trans_mp3_to_wav(music_mp3)
    play_audio(music_wav)
